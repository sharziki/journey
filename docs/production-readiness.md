...
Journey `v0.2.12` is the current production-ready beta release for:
...
- Release: <https://github.com/sharziki/journey/releases/tag/v0.2.12>
- Wheel: `journey_lang-0.2.12-py3-none-any.whl`
- Source distribution: `journey_lang-0.2.12.tar.gz`
...
/tmp/journey-verify/venv/bin/python -m pip install \
  https://github.com/sharziki/journey/releases/download/v0.2.12/journey_lang-0.2.12-py3-none-any.whl
...
- clean install from the public `v0.2.12` GitHub release wheel
...
- tag/version release preflight via `scripts/check_release_version.sh`
- `python -m build`
