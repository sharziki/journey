...
Journey `v0.2.2` is the current production-ready beta release for:
...
- Release: <https://github.com/sharziki/journey/releases/tag/v0.2.2>
- Wheel: `journey_lang-0.2.2-py3-none-any.whl`
- Source distribution: `journey_lang-0.2.2.tar.gz`
...
/tmp/journey-verify/venv/bin/python -m pip install \
  https://github.com/sharziki/journey/releases/download/v0.2.2/journey_lang-0.2.2-py3-none-any.whl
