...
Current production-ready beta: [`v0.2.7`](https://github.com/sharziki/journey/releases/tag/v0.2.7). See [production readiness](docs/production-readiness.md) for the verified e2e release checks and install path.
...
Journey is v0.2.7 beta. The core lightweight journey graph workflow and FastAPI adapter are usable today, with CI covering unit tests, shipped examples, generated acceptance tests, package builds, installed-artifact e2e, and release artifacts.
