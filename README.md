...
Current production-ready beta: [`v0.2.8`](https://github.com/sharziki/journey/releases/tag/v0.2.8). See [production readiness](docs/production-readiness.md) for the verified e2e release checks and install path.
...
Journey is v0.2.8 beta. The core lightweight journey graph workflow and FastAPI adapter are usable today, with CI covering unit tests, shipped examples, generated acceptance tests, package builds, installed-artifact e2e, checksums, and release artifacts.
