...
Current production-ready beta: [`v0.2.10`](https://github.com/sharziki/journey/releases/tag/v0.2.10). See [production readiness](docs/production-readiness.md) for the verified e2e release checks and install path.
...
Journey is v0.2.10 beta. The core lightweight journey graph workflow and FastAPI adapter are usable today, with CI covering unit tests, shipped examples, generated acceptance tests, package builds, installed-artifact e2e, dependency metadata checks, checksums, hash-verified install metadata, and release artifacts.
